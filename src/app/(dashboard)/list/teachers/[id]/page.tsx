        ...
        <div className="flex flex-col lg:flex-row gap-4">
          <div className="bg-sky-200 py-6 px-4 rounded-md flex-1 flex gap-4">
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              <h1 className="text-xl font-semibold">Sam Taylor</h1>
      ...
      <div className="w-full xl:w-2/3 flex flex-col gap-4 ">
        <div className="bg-white p-4 rounded-md">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
            <Link href="/" className="p-3 rounded-md bg-sky-200">Teacher&apos;s Classes</Link>
            <Link href="/" className="p-3 rounded-md bg-yellow-200">Teacher&apos;s Students</Link>
            <Link href="/" className="p-3 rounded-md bg-purple-200">Teacher&apos;s Lessons</Link>
            <Link href="/" className="p-3 rounded-md bg-pink-200">Teacher&apos;s Exams</Link>
            <Link href="/" className="p-3 rounded-md bg-sky-300">Teacher&apos;s Assignments</Link>
          </div>
        </div>
        <Performance />
        <Announcements />
